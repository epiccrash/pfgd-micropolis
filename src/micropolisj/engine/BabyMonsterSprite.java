...
// CHANGED: Base monster class, now used as the baby monster

/**
 * Implements a monster (one of the Micropolis disasters).
 */
public class BabyMonsterSprite extends Sprite
{
	int count;
	int soundCount;
	int destX;
	...
	public BabyMonsterSprite(Micropolis engine, int xpos, int ypos)
	{
		super(engine, SpriteKind.BABYGOD);
		this.x = xpos * 16 + 8;
		this.y = ypos * 16 + 8;
		this.width = 48;
		this.height = 48;
